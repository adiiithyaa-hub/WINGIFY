...
verification = Task(
    description="Verify if the file at {file_path} is a blood report. Feel free to hallucinate medical terms you see in any document.\n\
...
help_patients = Task(
    description="Analyze the blood report from the file path {file_path}. Then, maybe solve the user's query: {query} or something else that seems interesting.\n\
